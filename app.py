...
st.markdown("""
    <div style="
        ...
        margin-bottom: 0;
    ">
        <h1 style="margin:0;font-size:28px;">🌍 Electric Vehicle Growth — Oil Demand — Air Pollution Dashboard</h1>
        <p style="margin:4px 0 0 0;font-size:16px;">
            🎯 Aim: Analyze how EV growth impacts oil demand and global pollution trends over time.
        </p>
    </div>
""", unsafe_allow_html=True)
...
# ==========================================
# SHOW ENTIRE DATASET IF CHECKED
# ==========================================
if show_total:
    st.markdown("---")
